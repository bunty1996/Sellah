...
public class PayDialog_QRScan extends Dialog {
    ...
    public void pay_api(String amount) {
        ...
        Call<JsonObject> call = service.pay_money_scan(auth,token,HelperPreferences.get(context).getString(UID),PaymentFragment.qr_scan_id,amount,"sgd",PaymentFragment.card_id, PaymentFragment.customer_id);
