...
public class ChangePassDialog extends Dialog {
    ...
    private void verifyOTP() {
        if (Global.getText(edtConfirmPass).equalsIgnoreCase(Global.getText(edtNewPass))) {
            ...
            Call<Common> changePassCall = Global.WebServiceConstants.getRetrofitinstance().changePasswordApi(auth,token,HelperPreferences.get(context).getString(UID), Global.getText(edtCurrentPass), Global.getText(edtNewPass), Global.getText(edtConfirmPass));
