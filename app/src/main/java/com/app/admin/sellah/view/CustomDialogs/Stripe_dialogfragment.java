...
//                Log.e("Ip: ", ip);
    ...
    public void addtripeaccount(Context context,String routing) {
      ...
      //  Log.e("user", "" + HelperPreferences.get(context).getString(UID));
        Call<JsonObject> getProfileCall = service.stripeadd(auth,token,HelperPreferences.get(context).getString(UID), firstname, lastname, dob, pid, address, "SG", "Singapore", "Singapore", postalcodem, "SGD", accountnumber, routing, ip, "SG");
