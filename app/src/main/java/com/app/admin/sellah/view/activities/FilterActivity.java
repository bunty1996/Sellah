...
/********************************************************************************************/
    ...
    public void filterApi() {
        ...
        Call<GetProductList> fillterCall = service.applyFilterApi(auth,token,filterByPrice, condition, categoryId, paymentType, priceNegotiabilty, Global.getText(edtMinimumPrice), Global.getText(txtMaximumPrice), delivery);
