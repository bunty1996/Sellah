...
public class StreamedVideoDetail extends Activity {
    ...
    private void getChatData(String group_id) {
        ...
        Call<JsonObject> getChatData = Global.WebServiceConstants.getRetrofitinstance().getChatData(auth,token,HelperPreferences.get(this).getString(UID), group_id);
...
//                                Log.e("Dvsdvfdfv", message);
    ...
    private void setUpMessgae(ArrayList<HashMap<String, String>> models) {
        ...
        try {
            adapter = new LiveStreamChatAdapter(models, StreamedVideoDetail.this, "", new LiveStreamChatAdapter.OptionsClickCallBack() {
                @Override
