...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter(Context mainActivity, GetCategoriesModel expandableListTitle,/*,HashMap<HashMap<String, Integer>, ArrayList<HashMap<String, Integer>>> expandableListDetail*/MainActivityController controller) {
