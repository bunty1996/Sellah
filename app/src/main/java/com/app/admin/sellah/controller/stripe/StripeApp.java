...
//        mAuthUrl = "https://connect.stripe.com/oauth/authorize?response_type=code&client_id=ca_9bmLYpWBQDumLtFp2KZ7bE90kHjXS5le&scope=read_write&redirect_uri=https://developer.android.com/";
            ...
            public void run() {
                ...
                try {
                    ...
                    if (account != null) {
                        ...
                        Log.e(TAG, "run: "+account.getId());
                        Log.e(TAG, "run: "+account.getExternalAccounts());
