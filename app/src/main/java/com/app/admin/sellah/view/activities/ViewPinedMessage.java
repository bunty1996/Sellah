...
public class ViewPinedMessage extends AppCompatActivity {
   ...
   //     Log.e("groupId", "onCreate: " + groupId);
    ...
    private void getChatData() {
        ...
        dialog.show();
        Call<JsonObject> getChatData = Global.WebServiceConstants.getRetrofitinstance().getPinCommentApi(auth,token,HelperPreferences.get(this).getString(UID), groupId);
