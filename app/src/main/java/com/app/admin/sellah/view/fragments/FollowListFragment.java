...
public class FollowListFragment extends Fragment {
    ...
    private void unFollowUserApi(String otherUserId, int pos) {
        ...
        dialog.show();
        Call<FollowModel> getProfileCall = Global.WebServiceConstants.getRetrofitinstance().unFollowUserApi(auth,token,HelperPreferences.get(getActivity()).getString(UID), otherUserId);
