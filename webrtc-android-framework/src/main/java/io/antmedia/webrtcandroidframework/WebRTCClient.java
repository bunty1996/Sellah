...
/*
  public void startScreenPreview() {
    MediaProjectionManager mediaProjectionManager =null;
    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
      mediaProjectionManager = (MediaProjectionManager) this.activity.getApplication().getSystemService(
              Context.MEDIA_PROJECTION_SERVICE);
  ...
  private void startCall() {
    ...
    if (peerConnectionParameters.audioCallEnabled) {
      ...
      Log.d(TAG, "Unable to Star the audio manager...");
    }
  }
